...
const FeaturedLessonsCard = ({ lesson }) => {
  ...
  return (
    ...
    <div className="flex flex-col justify-between w-full bg-[#0a1120] border border-zinc-800/80 rounded-3xl p-6 shadow-xl relative overflow-hidden transition-all duration-300 hover:border-zinc-700/50 hover:shadow-2xl hover:shadow-purple-950/10 h-full group">
