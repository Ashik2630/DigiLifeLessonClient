...
import { Eye, EyeOff, Image, Loader2, Check, X, LogIn } from "lucide-react";
...
const RegisterPage = () => {
  ...
  // পাসওয়ার্ড ভ্যালিডেশন রুলস লজিক
      ...
      <div className="w-full max-w-md p-8 rounded-2xl border border-default-200/60 bg-background/50 backdrop-blur-md shadow-xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-foreground/60">
            Create an account to access your personal wisdom journal.
          </p>
        </div>
        {/* Error Feedback */}
        {signUpError && (
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-4 p-3 rounded-xl border-2 border-dashed border-default-200 hover:border-indigo-600 transition-colors relative bg-default-50/30">
              {imagePreview ? (
                <img
                  width={48}
                  height={48}
