...
const UnauthorizedPage = () => {
  ...
  return (
    <div className="min-h-screen bg-app-bg text-app-text flex flex-col items-center justify-center p-6 relative overflow-hidden ">
      ...
      <div className="max-w-md w-full border bg-app-bg text-app-text backdrop-blur-md rounded-[24px] p-8 text-center relative z-10 shadow-2xl space-y-6">
        
        {/* Animated Lock Icon with Gradient Border */}
        <div className="flex justify-center">
          <div className="relative group">
            <div className="absolute inset-0 bg-linear-to-r bg-app-bg text-app-text rounded-2xl blur opacity-40 group-hover:opacity-70 transition duration-500"></div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 justify-center">
          ...
          <Link
            ...
            className={`w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-linear-to-r bg-app-bg text-app-text border border-purple-500/30 text-xs font-semibold hover:from-purple-800/60 hover:to-fuchsia-800/60 hover:border-purple-400/50 transition-all shadow-lg ${
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-app-bg text-app-text border border-zinc-800 text-xs font-semibold  hover:text-zinc-200 hover:border-zinc-900 transition-all"
          >
